var P = (function() {
  ...
  IO.load = function(url, callback, self, type) {
    ...
    //console.log(url);
    // Redirect all wav files to a local blank file to prevent bad xhr calls offline
    //if(url.substr(url.length - 3) === 'wav'){
    //    url = 'lib/blank.wav'
    //}
  ...
  IO.loadLocalSB2File = function(file, callback, self){
      ...
      oReq.onload = function (oEvent) {
        ...
        cr.add(IO.loadSB2Project(oReq.response, function(result) {
            console.log(result);
          cr.defer = false;
